<?php
    ...
    if(isset($_SESSION["usuario"])){
        ...
        while($recons = mysqli_fetch_array($resGetRecon,MYSQLI_BOTH)){
			$html_reconocimientos.='<li><a class="borrar" data-recon="'.$recons[1].'">'.$recons[1].'</a></li>';
		}
...
<title>Borrar Reconocimiento</title>
...
<script src="./../js/registro/bReconocimiento.js"></script>
