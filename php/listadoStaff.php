<?php
    ...
    if(isset($_SESSION["usuario"])){
        ...
        $sqlGetStaff = "select * from staff;";
        $resGetStaff = mysqli_query($conexion,$sqlGetStaff);
        while($staff = mysqli_fetch_assoc($resGetStaff)){
			$html_staff.='<li><a class="ver" data-staff="'.$staff["usuario"].'">'.$staff["usuario"].'</a></li>';
		}
...
<script src="./../js/listado/listado_staff.js"></script>
