<?php
    ...
    if(isset($_SESSION["usuario"])){
		...
		if($sesion->tipoUsuario($usuario)==0){
			...
			$sqlVerStaff ="select * from staff where usuario='".$staff."';";
			$resVerStaff= mysqli_query($conexion, $sqlVerStaff);
			$staff = mysqli_fetch_assoc($resVerStaff);
...
<link rel="stylesheet" href="./../css/registro/eStaff.css">
...
<script src="./../js/registro/eStaff.js"></script>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-nombre" placeholder="Nombre" id="nombre" name="nombre" value="<?php echo $staff["nombre"];?>" required>
              </div>
              </div>
              </div>
              <div class="row">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-tel" placeholder="+(52) 0123456789" id="tel" name="tel" maxlength="13" value="<?php echo $staff["telefono"];?>">
              </div>
              </div>
              </div>
			  <br>
			  ...
			  <input class="escondido" name="usuario" id="usuario" value="<?php echo $staff["usuario"];?>">
          </form>
            </div>
            <!-- /.box-body -->
          </div>
