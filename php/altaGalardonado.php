...
<link href="./../css/registro/rGalardonado.css" rel="stylesheet">
...
<script src="./../js/registro/rGalardonado.js"></script>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-galardonado" placeholder="Nombre" id="galardonado" name="galardonado" required>
              </div>
              </div>
              <div class="col-xs-12 col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-primerApe" placeholder="Apellido" id="primerApe" name="primerApe" required>
              </div>
              </div>
              </div>
              <div class="row">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-segundoApe" placeholder="Apellido" id="segundoApe" name="segundoApe" required>
              </div>
              </div>
              <div class="col-xs-12 col-md-6">
              <h4>RFC</h4>
              <div class="input-group">
                <span class="input-group-addon form-rfc"><i class="fa fa-id-card"></i></span>
                <input type="text" class="form-control form-rfc" placeholder="RFCX999999WWW" id="rfc" name="rfc" maxlength="13" required>
              </div>
              </div>
              </div>
              <div class="row">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control form-correo" placeholder="ejemplo@email.com" id="correo" name="correo">
              </div>
              </div>
              <div class="col-xs-12 col-md-6">
              ...
              <h4>Observaciones</h4>
				<div class="md-form">
				  <textarea type="text" class="md-textarea form-control" id="observaciones" name="observaciones"></textarea>
				</div>
              </div>
              </div>
              <div class="row">
