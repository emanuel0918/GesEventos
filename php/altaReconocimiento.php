...
<link href="./../css/registro/rReconocimiento.css" rel="stylesheet">
...
<script src="./../js/registro/rReconocimiento.js"></script>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form id="formRecon" method="post">
			  <h3>Datos de la reconocimiento</h3>
              <div class="row">
              <div class="col-xs-12">
			  <h4>Reconocimiento</h4>
              <div class="input-group">
                <span class="input-group-addon form-recon"><i class="fa fa-university"></i></span>
                <input type="text" class="form-control form-recoon" placeholder="Nombre" id="recon" name="recon" required>
              </div>
              </div>
              </div>
			  <br>
              <div class="input-group btn-expand" >
                <input id="viewfile" type="submit" class="btn btn-primary btn-expand" value="Agregar">
              </div>
          </form>
            </div>
            <!-- /.box-body -->
