    ...
    if(isset($_SESSION["usuario"])){
        ...
        while($asistencia = mysqli_fetch_assoc($resGetAsistencia)){
				if($asistencia["asistencia"]==0){
					$filasAsistencia.='<li><a class="pasarLista" data-rfc="'
					.$asistencia["rfc"].'">'.$asistencia["nombre"].' '
					.$asistencia["primer_apellido"].' '.$asistencia["segundo_apellido"].'</a></li>';
				}
			$numero_registros++;
        }
...
<script src="./../js/listado/pasar_lista.js"></script>
