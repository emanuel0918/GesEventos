		...
		if($sesion->tipoUsuario($usuario)==0){
			...
			while($reconsGalardonado = mysqli_fetch_assoc($resGetReconGalardonado)){
				array_push($reconocimientosGalaradonado,$reconsGalardonado["reconocimiento"]);
					$html_reconocimientos.='<option value="'.$reconsGalardonado["reconocimiento"]
					.'">'.$reconsGalardonado["reconocimiento"].'</option>';
			}
			
			$sqlGetRecon = "select * from reconocimiento order by reconocimiento;";
			...
			while($escGalardonado = mysqli_fetch_assoc($resGetEscuelaGalardonado)){
				$escuelaGalardonado=$escGalardonado["escuela"];
			}
			$html_escuelas.='<option value="'.$escuelaGalardonado
			.'">'.$escuelaGalardonado.'</option>';
			
			$sqlGetEscuela = "select * from escuela order by escuela";
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-galardonado" placeholder="Nombre" id="galardonado" name="galardonado" value="<?php echo $galardonado["nombre"];?>" required>
              </div>
              </div>
              <div class="col-xs-12 col-md-4">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-primerApe" placeholder="Apellido" id="primerApe" name="primerApe" value="<?php echo $galardonado["primer_apellido"];?>" required>
              </div>
              </div>
              <div class="col-xs-12 col-md-4">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-segundoApe" placeholder="Apellido" id="segundoApe" name="segundoApe" value="<?php echo $galardonado["segundo_apellido"];?>" required>
              </div>
              </div>
              </div>
              <div class="row">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control form-correo" placeholder="ejemplo@email.com" id="correo" name="correo" value="<?php echo $galardonado["correo"];?>">
              </div>
              </div>
              <div class="col-xs-12 col-md-6">
              ...
              <h4>Observaciones</h4>
				<div class="md-form">
				  <textarea type="text" class="md-textarea form-control" id="observaciones" name="observaciones"><?php echo $galardonado["observaciones"];?></textarea>
				</div>
              </div>
              </div>
              <div class="row">
			  ...
			  <input class="escondido" name="rfc" id="rfc" value="<?php echo $rfc;?>">
          </form>
            </div>
            <!-- /.box-body -->
          </div>
