<?php
    ...
    if(isset($_SESSION["usuario"])){
        ...
        $sqlGetGalardonado = "select * from galardonado;";
        $resGetGalardonado = mysqli_query($conexion,$sqlGetGalardonado);
        while($galardonados = mysqli_fetch_array($resGetGalardonado,MYSQLI_BOTH)){
			$html_galardonados.='<li><a class="borrar" data-rfc="'
			.$galardonados[4].'">'.$galardonados[1]
			.' '.$galardonados[2].' '.$galardonados[3].'</a></li>';
		}
...
<title>Borrar Galardonado</title>
...
<script src="./../js/registro/bGalardonado.js"></script>
