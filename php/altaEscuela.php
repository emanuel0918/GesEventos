...
<link href="./../css/registro/rEscuela.css" rel="stylesheet">
...
<script src="./../js/registro/rEscuela.js"></script>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form id="formEscuela" method="post">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control form-escuela" placeholder="Nombre" id="escuela" name="escuela" required>
              </div>
              </div>
              </div>
			  <br>
