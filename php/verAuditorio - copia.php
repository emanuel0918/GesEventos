    ...
    if(isset($_SESSION["usuario"])){
        ...
        while($filas = mysqli_fetch_array($resGetFilas,MYSQLI_BOTH)){
			...
			while($asientos = mysqli_fetch_assoc($resGetAsientos)) {
				...
				.'","Status":'.$asientos["ocupado"].',"OriginalSeatStatus":0,"SeatsInGroup":null}';
				$i_asiento++;
			}
			if($i_fila!=0 && $i_fila!=($auditorio->altoAuditorio+1)){
				$html_asientos.='</tr>';
...
<link href="./../css/asientos/asientos.css" rel="stylesheet">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">	<form name="form1" method="post" action="visSeatingControl.aspx" id="form1">
