...
$( document ).ready(function() {
	 $.alert({
		...
		+" RFC, Sexo, Discapacidad, Correo, Telefono y Observaciones",
		onDestroy:function(){
									...
									for(index_registro=0;index_registro<nrows_json;index_registro++){
										$.ajax({
											...
											data:{nombre:rgs.registros[index_registro][0],
												...
												sexo: rgs.registros[index_registro][4],
												discapacidad: rgs.registros[index_registro][5],
												correo: rgs.registros[index_registro][6],
												tel: rgs.registros[index_registro][7],
												observaciones: rgs.registros[index_registro][8],
